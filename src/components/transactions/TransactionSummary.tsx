            ...
            <li key={item.id} className="p-5 ">
              <div className="flex items-center space-x-6 ">
                <div className="relative w-32 h-32">
                    <Image src={`${process.env.NEXT_PUBLIC_API_URL}${item.product.image}`} alt={item.product.name} fill />
                </div>
        ...
        <dl className="space-y-6  text-sm font-medium text-gray-500 p-5">
          <div className="flex justify-between">
            ...
            <dd className="text-gray-900">
                {transaction.coupon ? transaction.coupon : "Ninguno"}
            </dd>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <dd className="text-lg text-black font-black">${transaction.total}</dd>
          </div>
        </dl>
      </div>
    </>
